...
driver.get("https://resultados2025-2v.cne.gob.ec/")
wait = WebDriverWait(driver, 20) # Aumentar el tiempo de espera general

# --- Configuración CSV y Reanudación ---
output_path = r'C:\Users\juanm.PC-JUAN\Documents\Python\Ecuador\resultados_parroquias_2da.csv'
...
try:
    ...
    dignidad_btn = wait.until(EC.element_to_be_clickable((By.XPATH, "//a[contains(@class, 'myButtonDig')]")))
    dignidad_btn.click()
